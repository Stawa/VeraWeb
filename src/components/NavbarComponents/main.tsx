  ...
  return (
    <div className="relative">
      <button
        ...
        aria-haspopup="true"
        aria-label={t("languageMenu.selectLanguage")}
      >
        ...
        <div className="absolute right-0 mt-2 py-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-xl z-20">
          {availableLanguages.map((lang) => (
            <button
              ...
              aria-label={t("languageMenu.changeLanguage", {
                language: lang.name,
              })}
  ...
  return (
    <div className="md:hidden">
      <button
        ...
        aria-label={t("mobileMenu.toggleMobileMenu")}
      >
        <svg
          className="h-6 w-6"
          fill="none"
        ...
        <div className="absolute top-full left-0 right-0 bg-white/90 dark:bg-black/90 backdrop-blur-md shadow-md">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <button
              ...
              aria-label={t("mobileMenu.switchTheme", {
                mode: resolvedTheme === "dark" ? "light" : "dark",
              })}
            >
              <span className="flex items-center">
            ...
            <div className="relative">
              <button
                ...
                aria-expanded={isLanguageMenuOpen}
                aria-haspopup="true"
                aria-label={t("mobileMenu.selectLanguage")}
              >
                <span className="flex items-center justify-between">
                  <span className="flex items-center">
                    ...
                    <span>{t("mobileMenu.selectLanguage")}</span>
                  </span>
                  <svg
                ...
                <div className="mt-2 space-y-2 px-3">
                  {availableLanguages.map((lang) => (
                    <button
                      ...
                      aria-label={t("mobileMenu.changeLanguage", {
                        language: lang.name,
                      })}
                      onClick={() => handleLanguageChange(lang.code as Locale)}
                    >
